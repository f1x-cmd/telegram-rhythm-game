...
export const OFFICE = {
  ...
  hitPad: 1.22,
  bladeLife: 0.42,
  // Серая бомба должна ослеплять почти полностью, поэтому и рассеиваться
  // обязана быстро: при 0.9 непрозрачности прежние 0.32/с держали бы экран
  // закрытым почти три секунды.
  dustAmount: 1,
  dustDecay: 0.78,
};
